  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex max-w-7xl mx-auto">
        ...
        {/* Right Content Area */}
        <div className={`${showSidebar ? 'flex-1' : 'w-full'} p-6`}>
          {/* Unified top spacing & section header */}
          <div className="mb-6 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <h2 className="text-xl font-semibold tracking-tight">Search Papers</h2>
              <div
                className={
          ...
          {isLoading ? (
            <>
              <div className={`grid gap-4 mt-6 ${showSidebar ? 'grid-cols-1 lg:grid-cols-2' : 'grid-cols-1 lg:grid-cols-2 xl:grid-cols-3'}`}>
