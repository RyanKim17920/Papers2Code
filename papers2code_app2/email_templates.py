...
def get_author_outreach_email_template(paper_title: str, paper_link: str) -> Dict[str, str]:
    ...
    """
    subject = f"Opportunity to Share Code for Your Paper: {paper_title} on Papers2Code"
    body = f"""Dear Author,

We hope this email finds you well.

We are reaching out from Papers2Code (papers2code.com), a community-driven platform dedicated to bridging the gap between academic research and practical implementation. Our goal is to foster a collaborative environment where researchers and developers can share, discuss, and implement the algorithms and models described in academic papers.
...
The Papers2Code Team

(Note: This email was generated by the Papers2Code system for you to send manually. Please replace '[Your Email Address Here]' with your actual sending email address before sending.)
"""
